...
export const OBJECTIVES: ObjectiveDef[] = [
  ...
  { id: 'conquer-1', title: 'Manifest destiny', description: 'Raise an army, march it next to independent land, and take the province.', reward: 80, check: (_, p) => count(p.stats.tribalConquests, 1) },
  ...
  { id: 'army-24', title: 'A standing army', description: 'Field 24 units at once, in garrisons and armies together.', reward: 100, check: (s, p) => count(armySize(nationArmy(s, p.id)), 24) },
